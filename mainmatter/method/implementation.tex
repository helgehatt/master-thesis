...
\subsection{Node Batching}
    ...
    \subsubsection{Sparse Sociomatrix}
        ...
        The only available sparse representation of a PyTorch tensor is the COO-format. COO is an abbreviation of coordinate list, where each non-zero value is associated with a pair of coordinates. Considering the previously used example sociomatrix in \Cref{eq:BatchIndex}, the following information is stored:
