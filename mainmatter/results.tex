...
\subsection{Static Data}
    ...
    \xfig{\ximg{Results/Static/Train/StaticModel-AR(1)-Undirected-NoLoss}}
    
    \xhex{\ximg{Results/Static/Proba/StaticModel-AR(1)-Undirected-True}[True]}
    {\ximg{Results/Static/Proba/StaticModel-AR(1)-Undirected-NoLoss}[S-LSM]}
    {\ximg{Results/Static/Proba/DiffusionModel-AR(1)-Undirected-NoLoss}[D-LSM]}
    {\ximg{Results/Static/Proba/AutoregressiveModel-AR(1)-Undirected-NoLoss}[AR(1)]}
    {\ximg{Results/Static/Proba/AutoregressiveModel-AR(2)-Undirected-NoLoss}[AR(2)]}
    {\ximg{Results/Static/Proba/AutoregressiveModel-AR(3)-Undirected-NoLoss}[AR(3)]}
