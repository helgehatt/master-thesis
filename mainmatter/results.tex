...
\xtab{\xdirow[0.6]
    {\xdicol
        {\xtex{AbbrvModels}}
        {
            There is a large number of different models to consider due to the number of ways to combine model types, parameters and diffusion penalties. First of all, there are three different models, where the autoregressive model can have an arbitrary order. Each of these models can either be directed or undirected, and with an arbitrary dimensionality. 
        }
    }{\xdicol
        {\xtex{AbbrvParams}}
        {\xtex{AbbrvPenalties}}
...
\subsection{Static Data}
    ...
    \xfig[H]{\xanim{Results/Static/Train/StaticModel-AR(1)-Undirected-NoLoss}}
    ...
    \xfig[H]{\ximg[width=0.8\textwidth]{Results/Static/AUC-Undirected-NL}[Test | U | K(2) | NL]}
...
\subsection{Dynamic Data}
    ...
    \xfig[H]{\ximg[width=0.8\textwidth]{Results/Dynamic/AUC-Undirected-GNV}[Test | U | K(2) | GNV]}
